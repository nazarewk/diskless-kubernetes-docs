...
operacyjnego CoreOS z wykorzystaniem repozytorium
...
konfigurującej węzeł roboczy.

Następnie w celu dodania węzła do klastra wystarczyło wywołać uzyskaną
komendę na dowolnej liczbie maszyn wirtualnych:
