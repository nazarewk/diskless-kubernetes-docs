...
System operacyjny musi wspierać uruchamianie się w takim środowisku.
...
procesie inicjalizacji systemu aktualnie nia ma możliwości uruchomienia
systemu operacyjnego w trybie bezdyskowym.
...
Systemy operacyjne przeznaczone do działania w chmurze są bardzo do siebie
zbliżone i wybór dystrybucji nie ma wielkiego znaczenia dla działania
bezdyskowego klastra Kubernetes.

W dalszej części skupię się na wykorzystaniu CoreOSa jako systemu od początku
wspierającego Kubernetes.
