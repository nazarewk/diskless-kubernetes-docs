...
Systemy operacyjne przeznaczone do działania w chmurze pod kątem naszego
zastosowania są efektywnie identyczne i wybór dystrybucji nie ma wielkiego
znaczenia dla działania bezdyskowego klastra Kubernetes.
