...
zagadnień związanych z Kubernetes oraz oddałem do użytku skrypty konfigurujące
klaster Kubernetes wraz z prostym w obsłudze dodawaniem i usuwaniem jego
użytkowników.
